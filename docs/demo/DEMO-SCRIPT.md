...
## Scene 6 — `06-transparency-stats` · Open books
**Say:** "This is my favorite page. The big number is what's left to request this year, next to the annual budget and what we've awarded so far. It recalculates whenever an award changes."

## Scene 7 — `07-transparency-table` · Every decision
**Say:** "Below that, every decision we've made, grouped by quarter with subtotals. Including the requests we turned down, and the reason why. Students fund this budget, so they get to see all of it."

## Scene 8 — `08-form` · One form
**Say:** "Requesting funding is now one form. The policies are linked right at the top, and the request limit is called out before anyone starts typing."

## Scene 9 — `09-form-filled` · The form knows the rules
**Say:** "The form also knows our policies. This club is asking for three hundred fifty dollars, over the limit for outside organizations, so a justification box appears automatically. That used to cost clubs a two week resubmission."

## Scene 10 — `10-confirmation` · A clear answer
**Say:** "After submitting, students see exactly what happens next, with the real meeting time and room number. It's a small thing, but it saves our inbox a lot of nervous follow-up emails."

## Scene 11 — `11-admin-edit` · Editing is a form
